...
import com.example.react_native_cosser.R;//com.example.react_native_cosser.R;
...
import com.example.react_native_cosser.easeui.recorder.MediaManager;
import com.example.react_native_cosser.easeui.runtimepermission.PermissionsManager;
import com.example.react_native_cosser.easeui.runtimepermission.PermissionsResultAction;
import com.example.react_native_cosser.easeui.util.CommonUtils;
import com.example.react_native_cosser.easeui.util.Config;
import com.example.react_native_cosser.easeui.widget.AlertDialog;
import com.example.react_native_cosser.easeui.widget.EaseChatInputMenu;
import com.example.react_native_cosser.easeui.widget.ExtendMenu;
...
//    protected int[] itemResIds = {R.id.chat_menu_take_pic, R.id.chat_menu_pic, R.id.chat_menu_video, R.id.chat_menu_file};
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new MessageList.MessageListItemClickListener() {
            ...
            public void onResendClick(final Message message) {
                new AlertDialog(getActivity(), R.string.resend, R.string.confirm_resend, null, new AlertDialog.AlertDialogUser() {
                    @Override
    ...
    protected void emptyHistory() {
        ...
        new AlertDialog(getActivity(), null, msg, null, new AlertDialog.AlertDialogUser() {
